...
namespace SAT_Project.UI.MVC.Controllers
{
    ...
    public class StudentStatusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Ssid,Ssname,Ssdescritpion")] StudentStatus studentStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Ssid,Ssname,Ssdescritpion")] StudentStatus studentStatus)
        {
